...
def referral() -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(text=LazyProxy("invite_friend"), callback_data="invite_friend"),
            InlineKeyboardButton(text=LazyProxy("my_referral_button"), callback_data="my_referrals")
        ],
        [
