...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "moderator", name="roleenum"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "completed", "failed", name="statuspaymentenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "expired", "cancelled", name="statussubscriptionenum"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
